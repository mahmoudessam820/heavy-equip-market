...
<template>
    ...
    <section id="used-equipment-details">
                ...
                <div class="flex flex-col md:flex-row -mx-4">
                    ...
                    <div class="md:flex-1 px-4 flex flex-col justify-center items-center">
                        ...
                        <div class="w-full px-2">
                            <button class="w-full bg-black text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-[#fec70b]">Request A Quote</button>
                        </div>

                    </div>

                    <div class="md:flex-1 px-4">
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">2019 Cat 12M3</h2>
